...
#set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {sw_ck}]
...
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {test_leds[1]}]
#set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {test_leds[0]}]
